...
var defaults = {
	allowedArgs: ['testPath', 'runner', 'notifier', 'applicationName'],
	testPath: './',
	runner: 'index.html',
...
module.exports = {
	...
	notify: function(data){
		...
		notifiers.send({
			...
			text: 'Total: ' + data.total + ' Passed: ' + data.passed + ' Failed: ' + data.failed,
			icon: fs.readFileSync(path.join(__dirname, '..', 'resources', 'icons', 'error.png'))
		});
	},
